    ...
    <div>
      <Row type="flex">
        <Col xs={10} md={12}>
          ...
          <InputNumber size="large" formatter={unitFormatter(0)} min={1} max={100000}
                       value={converter.awg} onChange={onChangeAwg}/>
        </Col>
        <Col xs={10} md={12}>
          <Typography.Text>mm</Typography.Text>
          <InputNumber size="large" min={0} max={100000} step={0.01}
                       formatter={unitFormatter(3)}
                       value={converter.mm} onChange={onChangeMm}/>
        </Col>
      </Row>
    </div>
  );
