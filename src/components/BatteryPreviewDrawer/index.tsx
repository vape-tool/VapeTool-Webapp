...
const BatteryPreviewDrawer: React.FC<BatteryPreviewDrawerProps> =
  (props: BatteryPreviewDrawerProps) => {
    ...
    const toggleEditBattery = () => dispatch({
    ...
    const {
      brand, model, chemistry, size, capacity, maxVapingCurrent,
      stableCurrent, cutOff, reviewUrl, voltage, url, affiliate,
    } = selectedBattery;
    ...
    return (
      ...
      >
        ...
        <Row>
          ...
          <Col span={12}>
            <DescriptionItem title="Min. stable resistance" content={(voltage / stableCurrent).toFixed(3)}/>
          </Col>
        </Row>
        <Row>
          <Col span={12}>
          ...
          <Col span={12}>
            <DescriptionItem title="Min. vaping resistance" content={(voltage / maxVapingCurrent).toFixed(3)}/>
          </Col>
        </Row>
        <Row>
          <Col span={12}>
        ...
        <Row><Col xs={12}><span style={pStyle}>Links</span></Col>
          {user && user.permission >= UserPermission.ONLINE_MODERATOR &&
          <Col xs={12}><Button type="link" onClick={toggleEditBattery}>Edit affiliates</Button></Col>}
        </Row>


        <Row type="flex" gutter={32}>
          {reviewUrl && <Col xs="auto"><a style={{
