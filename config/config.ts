          ...
          routes: [
            {
              ...
              routes: [
                ...
                },
                {
                  ...
                  icon: '/img/menu_icons/menu_coil_calculator.svg',
                  component: './coil/CoilCalculator',
                },
                {
                  path: '/liquid-blender',
                  name: 'liquid-blender',
                  icon: '/img/menu_icons/menu_liquid_blender.svg',
                  component: './liquid/LiquidBlender',
                },
                {
                  path: '/ohm-law',
                  name: 'ohm-law',
                  icon: '/img/menu_icons/menu_ohm_law.svg',
                  component: './ohm/OhmLaw',
                },
                {
                  path: '/batteries',
                  name: 'batteries',
                  icon: '/img/menu_icons/menu_batteries.svg',
                  component: './batteries/Batteries',
                },
                {
                  path: '/converters',
                  name: 'converters',
                  icon: '/img/menu_icons/menu_converters.svg',
                  component: './converters/Converters',
                },
                {
                  path: '/battery-life',
                  name: 'battery-life',
                  icon: '/img/menu_icons/menu_battery_life.svg',
                  component: './batterylife/BatteryLife',
                },
                {
                  path: '/knowledge',
                  name: 'knowledge',
                  icon: '/img/menu_icons/menu_knowledge_zone.svg',
